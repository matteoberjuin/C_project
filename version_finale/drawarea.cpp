...
void DrawArea::paintEvent(QPaintEvent* /*event*/)
{
    ...
    painter.drawText(50, 40, "J1(rouge) : " + QString::number(ctx_.score_j1));
    painter.drawText(width() - 100, 40, "J2(jaune) : " + QString::number(ctx_.score_j2));
