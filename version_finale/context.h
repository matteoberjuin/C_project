...
public:
    ...
    bool est_ce_que_ca_bouge_encore() const;
    bool blanche_en_attente_ = false;
    void replacerBlanche(Vec2 pos);
    int score = 0;
    int score_j1 = 0;
    int score_j2 = 0;
    int joueur_actuel = 1;
    bool une_bille_est_rentree = false;
...
private:
    ...
    void enforceDynamicConstraintSpeed(const DynamicConstraint& c, Particle& p1, Particle& p2);
